...
export function TransactionsErrorState({ onRetry }) {
  return (
    <section className="rounded-3xl border border-red-400/20 bg-red-500/10 p-6 text-red-100">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex gap-3">
          ...
          <div>
            <h2 className="font-semibold">Transactions could not load</h2>
            <p className="mt-1 text-sm text-red-100/75">
              Check the backend connection and try again. Your existing data is
              safe.
            </p>
          </div>
        </div>
